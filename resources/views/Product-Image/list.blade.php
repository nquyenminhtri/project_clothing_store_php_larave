                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="file" class="form-control" name="images[]" multiple
                                    onchange="handleFileChange.call(this)" required="true">
                            ...
                            @foreach ($productImageList as $productImage)
                                <tr>
                                    ...
                                    <td><img style="width: 100px; height: 100px;"
                                            src="{{ asset('product-images/' . $productImage->name) }}" alt="no image">
                                    </td>
                                    <td style="display:flex;align-items: center;">
                                        ...
                                        |
                                        <form method="POST"
                                            action="{{ route('productImage.delete', ['productId' => $productImage->id]) }}">
                                            @csrf
